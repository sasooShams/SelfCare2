...
public class Registrion extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextFirstName=(EditText)findViewById(R.id.input_FrName);
        editTextLastName=(EditText)findViewById(R.id.input_LaName);
        editTextPassword=(EditText)findViewById(R.id.input_password);
        editTextEmail=(EditText)findViewById(R.id.input_email);
        editTextPhoneNumber=(EditText)findViewById(R.id.input_phoneNum);
        editTextWeight=(EditText)findViewById(R.id.input_weight);
        editTextHeight=(EditText)findViewById(R.id.input_height);
        TextView login=(TextView)findViewById(R.id.txLogin);
            ...
            public void onClick(View v) {
                try {
                   reg.getData();
                    ...
                    Toast.makeText(Registrion.this,E.toString(),Toast.LENGTH_SHORT).show();
    ...
    public void showDialogOnButtonClick(){
        but_ds=(Button)findViewById(R.id.btnBirthDate);
    ...
    private DatePickerDialog.OnDateSetListener dpickerListener=new DatePickerDialog.OnDateSetListener(){
        ...
        public void onDateSet(DatePicker view,int year,int monthOfYear,int dayOfMonth){
            ...
            month =monthOfYear + 1;
            day =dayOfMonth;
            Toast.makeText(Registrion.this,year +"/"+ month +"/"+ day,Toast.LENGTH_SHORT).show();
        }
    };
...
String Gender ="";
            ...
            public void onClick(View v) {
                ...
                //< do some thing >
                    ...
                    try {
                        ...
                        long id = reg.insert_data(FName, LName, EEmail, Passward, Mobile, BirthDate, Weights, Heights, Gender);
    ...
    public boolean validate() {
        ...
        if (valid){
            ...
            editor.putString( "Paient_email",EEmail);
            editor.commit();
